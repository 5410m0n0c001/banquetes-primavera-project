# 📂 Base de Conocimiento RAG - Primavera Events Group
> **Documento Consolidado de Paquetes, Locaciones, Servicios, Menús y Estrategia Comercial**
> *Generado de forma consolidada e integrada en español para consulta directa y entrenamiento RAG*
...
11. [👥 Organigrama y Equipo de Colaboradores Reales](#-organigrama-y-equipo-de-colaboradores-reales)
12. [🎨 Manual de Branding e Identidad Visual y Sonora](#-manual-de-branding-e-identidad-visual-y-sonora)
13. [🚀 Plan Estratégico de Marketing (Campaña Mensual)](#-plan-estratégico-de-marketing-campaña-mensual)
...
### 🌟 Paquete Gobernador
* **Locación Predilecta / Principal**: Centro de Convenciones Presidente (Avenida Defensa Nacional 8, Chamilpa, Cuernavaca, Morelos)
* **Duración**: 9 horas (Hasta las 00:00 hrs)
* **Página de Referencia**: [Enlace al sitio](https://primaveraeventsgroup.com/paquete-gobernador/)
...
#### 🍽️ Estructura del Menú (3 Tiempos):
...
| Número de Invitados | Costo por Persona | Detalles y Cobertura |
| --- | --- | --- |
| 100 - 149 personas | **$899.00 MXN** | Incluye degustación y decoración básica |
| 150 - 199 personas | **$849.00 MXN** | Incluye degustación y decoración básica |
| 200 - 299 personas | **$799.00 MXN** | Incluye degustación y decoración básica |
| 300 - 400 personas | **$749.00 MXN** | Incluye degustación y decoración básica |
| 401+ personas | **Consultar / Personalizado** | Personalizado según necesidades |
...
### 🌟 Paquete Presidente
* **Locación Predilecta / Principal**: Centro de Convenciones Presidente (Avenida Defensa Nacional 8, Chamilpa, Cuernavaca, Morelos)
* **Duración**: 9 horas (Hasta las 01:00 hrs)
* **Página de Referencia**: [Enlace al sitio](https://primaveraeventsgroup.com/paquete-presidente/)
...
- Agua fresca (2 sabores).
- Crudités (pepino, jícama y zanahoria con miguelito y chamoy).
- Mesa principal de honor con sillón o sillones Rey & Reyna, templete de madera, centro floral natural.
...
#### 🍽️ Estructura del Menú (4 Tiempos):
...
* **Locación Predilecta / Principal**: Privada las Fuentes s/n, San Gaspar, Jiutepec, Morelos
* **Duración**: 8 horas (Hasta las 01:00 hrs)
* **Página de Referencia**: [Enlace al sitio](https://primaveraeventsgroup.com/paquete-esencia-floral/)
...
| Número de Invitados | Costo por Persona | Detalles y Cobertura |
| --- | --- | --- |
| 100 - 199 personas | **$999.00 MXN** | Incluye degustación y decoración básica |
| 200 - 300 personas | **$899.00 MXN** | Incluye degustación y decoración básica |
...
* **Locación Predilecta / Principal**: Múltiples locaciones en Morelos (Xochitepec, Cuernavaca, Jiutepec, Temixco)
* **Duración**: Coordinación completa.
...
#### 💰 Tabla de Precios por Persona (Sujeta a escala de invitados):
| Locación / Jardín | Rango de Invitados | Precio Standard / Especial (Costo por Persona) | Detalle |
| --- | --- | --- | --- |
| **Finca las Isabeles (Xochitepec)** | 200 - 400 invitados | **$999.00 / $949.00 MXN** | Precio Standard / Precio Especial |
| **Jardín Nautilus (Xochitepec)** | 300 - 400 invitados | **$999.00 / $849.00 MXN** | Precio Standard / Precio Especial |
| **C.C Presidente (Cuernavaca)** | 200 - 500 invitados | **$949.00 / $899.00 MXN** | Precio Standard / Precio Especial |
| **Villa San Gaspar (Jiutepec)** | 200 - 400 invitados | **$999.00 / $949.00 MXN** | Precio Standard / Precio Especial |
| **Jardín San Rafael (Jiutepec)** | 300 - 800 invitados | **$999.00 / $949.00 MXN** | Precio Standard / Precio Especial |
| **Jn Paraiso de lago (Jiutepec)** | 200 - 300 invitados | **$999.00 / $949.00 MXN** | Precio Standard / Precio Especial |
| **Jardín Yolomecatl (Temixco)** | 200 - 500 invitados | **$799.90 / $749.00 MXN** | Precio Standard / Precio Especial |
| **Quinta Zarabanda (Temixco)** | 200 - 300 invitados | **$999.00 / $949.00 MXN** | Precio Standard / Precio Especial |
...
### 🌟 Paquete Armonía
* **Locación Predilecta / Principal**: Quinta Zarabanda (Avenida Lauro Ortega Martínez 4, Las Animas, Temixco, Morelos)
* **Duración**: 10 horas continuas (Sin restricción de horario)
* **Página de Referencia**: [Enlace al sitio](https://primaveraeventsgroup.com/paquete-armonia/)
...
#### 🍽️ Estructura del Menú (3 Tiempos + Menú Infantil):
...
| Número de Invitados | Costo por Persona | Detalles y Cobertura |
| --- | --- | --- |
| 100 - 150 personas | **$1,700.00 MXN** | Incluye degustación y ambientación de lujo |
| 151 - 250 personas | **$1,450.00 MXN** | Incluye degustación y ambientación de lujo |
...
* **Locación Predilecta / Principal**: Jardín La Flor u otros jardines campestres selectos en Morelos
* **Duración**: 8 a 9 horas continuas
* **Página de Referencia**: [Enlace al sitio](https://primaveraeventsgroup.com/paquete-vuelo-esmeralda/)
...
| Número de Invitados | Costo por Persona | Detalles y Cobertura |
| --- | --- | --- |
| 100 - 149 personas | **$2,199.00 MXN** | Servicio premium completo |
| 150 - 199 personas | **$2,099.00 MXN** | Servicio premium completo |
| 200 - 299 personas | **$1,999.00 MXN** | Servicio premium completo |
...
* **Locación Predilecta / Principal**: Locación de estilo Hacienda / Hípico o Quinta con temática rústica
* **Duración**: Típicamente 8 a 9 horas.
* **Página de Referencia**: [Enlace al sitio](https://primaveraeventsgroup.com/paquete-imperial-ecuestre/)
...
| Número de Invitados | Costo por Persona | Detalles y Cobertura |
| --- | --- | --- |
| 100 - 199 personas | **$749.00 MXN** | Precio de escala inicial |
| 200 - 299 personas | **$729.00 MXN** | Precio preferente |
| 300 - 400 personas | **$699.00 MXN** | Precio de escala máxima |
...
* **Locación Predilecta / Principal**: Jardín Yolomecatl / Salón Jardín Yolomecatl (Temixco, Morelos)
* **Duración**: 9 horas continuas
* **Página de Referencia**: [Enlace al sitio](https://primaveraeventsgroup.com/paquete-destino-yolomecatl/)
...
| Número de Invitados | Costo por Persona | Detalles y Cobertura |
| --- | --- | --- |
| 100 - 149 personas | **$899.00 MXN** | Básico completo |
| 150 - 199 personas | **$849.00 MXN** | Preferente completo |
| 200 - 299 personas | **$799.00 MXN** | Especial completo |
| 300 - 400 personas | **$749.00 MXN** | Escala máxima preferente |
...
* **Locación Predilecta / Principal**: Locación de estilo Hacienda Ecuestre o rancho rústico-elegante
* **Duración**: 9 horas continuas
* **Página de Referencia**: [Enlace al sitio](https://primaveraeventsgroup.com/paquete-linaje-pura-sangre/)
...
| Número de Invitados | Costo por Persona | Detalles y Cobertura |
| --- | --- | --- |
| 100 - 149 personas | **$799.00 MXN** | Precio base |
| 150 - 199 personas | **$749.00 MXN** | Precio preferente |
| 200 - 299 personas | **$699.00 MXN** | Precio especial |
| 300 - 400 personas | **$649.00 MXN** | Precio de escala máxima |
...
* **Locación Predilecta / Principal**: Jardín ecológico / Quinta campestre rodeada de abundante bosque y cabañas
* **Duración**: 9 horas continuas
* **Página de Referencia**: [Enlace al sitio](https://primaveraeventsgroup.com/paquete-natures-majesty/)
...
| Número de Invitados | Costo por Persona | Detalles y Cobertura |
| --- | --- | --- |
| 100 - 149 personas | **$1,999.00 MXN** | Servicio campestre ecológico de lujo |
| 150 - 199 personas | **$1,899.00 MXN** | Servicio campestre ecológico de lujo |
| 200 - 299 personas | **$1,799.00 MXN** | Servicio campestre ecológico de lujo |
...
## 📸 Paquetes de Fotografía y Video

### 📷 Paquete Experiencia Deluxe (Fotografía y Video)
* **Tipo**: Servicio de Fotografía y Video para Quinceañeras.
* **Costo Total**: **$10,900.00 MXN**
* **Depósito de Apartado (10%)**: `$990.00 MXN`
* **Saldo a Liquidar en el Evento**: `$9,910.00 MXN`
* **Página de Referencia**: [Enlace al sitio](https://primaveraeventsgroup.com/paquete-experiencia-deluxe/)

#### 💎 Inclusiones e Entregables:
...
- Estuche de madera fina grabado personalizado para USB.
...
### 📷 Paquete Cinematic Prestige (Fotografía y Video)
* **Tipo**: Servicio Premium de Producción Cinematográfica y Foto para Eventos.
* **Costo Total**: **$13,900.00 MXN**
* **Depósito de Apartado (10%)**: `$1,390.00 MXN`
* **Saldo a Liquidar en el Evento**: `$12,510.00 MXN`
* **Página de Referencia**: [Enlace al sitio](https://primaveraeventsgroup.com/paquete-cinematic-prestige/)

#### 💎 Inclusiones e Entregables:
- Grabación cinematográfica a dos cámaras simultáneas para máxima cobertura y ángulos.
- Uso de drones profesionales de última generación en 4K para tomas aéreas.
...
### 📷 Paquete Royal Cinematic (Fotografía y Video)
* **Tipo**: Servicio de Alta Gama de Fotografía y Video para Bodas.
* **Costo Total**: **$12,900.00 MXN / $13,900.00 MXN**
* **Depósito de Apartado (10%)**: `$1,900.00 MXN (opción 1) / $1,390.00 MXN (opción 2)`
* **Saldo a Liquidar en el Evento**: `$11,000.00 MXN (opción 1) / `$12,510.00 MXN (opción 2)`
* **Página de Referencia**: [Enlace al sitio](https://primaveraeventsgroup.com/paquete-royal-cinematic/)
...
#### ⚠️ Sanciones y Términos:
- En caso de no cumplir con el pago total el día del evento, se sancionará con $2,500.00 MXN o se procederá a la retención/eliminación definitiva del material.
...
### 📷 Paquete Eternal Promise (Fotografía)
* **Tipo**: Servicio Clásico de Fotografía Profesional para Bodas.
* **Costo Total**: **$9,900.00 MXN**
* **Depósito de Apartado (10%)**: `$990.00 MXN`
* **Saldo a Liquidar en el Evento**: `$8,910.00 MXN`
* **Página de Referencia**: [Enlace al sitio](https://primaveraeventsgroup.com/paquete-eternal-promise/)
...
### 📷 Paquete Memoria Clásica (Fotografía)
* **Tipo**: Servicio Esencial de Fotografía Profesional.
* **Costo Total**: **$9,350.00 MXN**
* **Depósito de Apartado (10%)**: `$850.00 MXN`
* **Saldo a Liquidar en el Evento**: `$8,500.00 MXN`
* **Página de Referencia**: [Enlace al sitio](https://primaveraeventsgroup.com/paquete-memoria-clasica/)
...
### 🥗 Menú Gourmet Primavera 2026
* **Descripción**: Menú sofisticado diseñado especialmente para eventos de gala, bodas y XV años, caracterizado por una estética impecable y un gran equilibrio culinario.
* **Página de Referencia**: [Enlace al sitio](https://primaveraeventsgroup.com/menu-gourmet/menu-primavera-2026/)

#### 🔸 Seccional: ENSALADAS
- **Ensalada Mediterránea**: *Mezcla de lechugas, queso de cabra, jitomates cherry, manzana, germen de alfalfa y vinagreta dulce.*
- **Ensalada de Nuez a la Naranja**: *Mezcla de espinaca, lechugas, nuez caramelizada, manzana y queso blanco con salsa de naranja y miel.*
- **Ensalada de la Casa**: *Mezcla de lechugas con pepino, jitomate, cebolla, zanahoria y vinagreta con base de vinagre balsámico.*
- **Ensalada Primavera Exótica de Mango**: *Tiras de mango fresco sobre una cama de lechuga con pasta Fusilli, fresas frescas y vinagreta artesanal de mango.*
- **Ensalada de Frutos Rojos**: *Servido sobre aro de pepino con una mezcla de lechugas baby, frutos rojos y reducción fina de balsámico.*

#### 🔸 Seccional: ENTRADAS CALIENTES
- **Costalito de Champiñón al Ajillo**: *Servido sobre un espejo de salsa de chile guajillo.*
- **Crepa Poblana**: *Crepa rellena de chile poblano en rajas, granos de elote y pollo deshebrado en salsa poblana cremosa.*
- **Crepa de Champiñones y Flor de Calabaza**: *Crepa rellena de champiñones guisados y bañada en salsa cremosa de flor de calabaza.*
- **Rollito de Cochinita Pibil**: *Servido sobre un espejo de salsa de piña con chile habanero y coronado con cebollas moradas encurtidas.*

#### 🔸 Seccional: CREMAS Y SOPAS
- **Crema de Brócoli**: *Cremosa sopa de brócoli presentada con un crotón crujiente.*
- **Crema de Nuez**: *Crema fina presentada con nueces espolvoreadas al centro.*
- **Crema Poblana**: *Crema suave de chile poblano presentada con granos de elote y cuadritos de chile poblano asado.*
- **Crema de Tres Quesos**: *Elaborada con una base selecta de quesos Gruyère, azul y queso fresco.*
- **Crema de Chicharrón**: *Crema de chicharrón de cerdo perfumada con un toque de chile guajillo.*
- **Crema Suiza al Chipotle**: *Crema suave y picante de chipotle presentada con trocitos de queso derretido.*
- **Crema de Pimientos y Uvas**: *Crema de pimiento morrón con una guarnición de uvas frescas al centro.*
- **Crema de Cilantro**: *Crema aromática de cilantro presentada con trocitos de nuez pecana.*

#### 🔸 Seccional: PASTAS
- **Pasta Napolitana**: *Espagueti clásico servido con una rica salsa pomodoro hecha en casa.*
- **Pasta Arrabbiata**: *Pasta Fusilli preparada con salsa picante arrabbiata y abundante queso parmesano rallado.*
- **Pasta Carbonara**: *Fetuccini bañado en una salsa carbonara a base de tocino dorado, yema y crema.*
- **Pasta al Pesto**: *Espagueti servido con un pesto de albahaca fresca, aceite de oliva virgen y parmesano.*
- **Espagueti en Salsa de Queso de Cabra**: *Espagueti al burro servido con una sedosa salsa cremosa de queso de cabra y decorada con perejil fresco.*

#### 🔸 Seccional: PLATOS FUERTES CERDO
- **Pierna Almendrada**: *Láminas de pierna bañadas en una salsa súper cremosa de almendras tostadas.*
- **Pierna a la Madrileña**: *Acompañada de una salsa a base de graybi, vino tinto y cebolla cambray asada.*
- **Pierna a la Sangría**: *Bañada con una salsa dulce a base de su gravy natural, vino tinto y jugo de uvas.*
- **Lomo al Tamarindo**: *Exquisita pieza bañada en salsa agridulce de tamarindo y chile morita picante.*
- **Pierna en Salsa de Ciruela**: *Pierna horneada bañada en una salsa tersa y dulce de ciruela pasa.*
- **Lomo de Cerdo Mechado**: *Lomo relleno de frutos secos con nuez y pistaches en su salsa gravy.*

#### 🔸 Seccional: PLATOS FUERTES POLLO
- **Pechuga Cordon Bleu**: *Pechuga empanizada rellena de jamón y queso, acompañada de una salsa blanca de hongos.*
- **Volcán de Pollo a la Poblana**: *Pechuga rellena de mezcla de requesón con salsa cremosa poblana al centro.*
- **Pechuga a los Tres Chiles**: *Bañada en salsa rosada acompañada de trozos de pimiento morrón rojo y amarillo y chile poblano.*
- **Rollo de Pollo a la Hawaiana**: *Pechuga rellena de espinaca, jamón y queso en salsa agridulce de piña picante.*
- **Pechuga de Huitlacoche**: *Pechuga de pollo rellena de huitlacoche (hongo de maíz) acompañado de una salsa poblana.*
- **Pechuga de Frutos Secos**: *Pechuga rellena de frutos secos (manzana, chabacano, ciruelas) y queso crema con salsa blanca dulce.*
- **Rollos de Pollo con Setas**: *Bañada en una salsa cremosa de chipotle y setas asadas.*
- **Suprema de Pollo al Cilantro**: *Suprema rellena de mezcla de espinacas con queso Philadelphia, bañada en una salsa de cilantro.*

#### 🔸 Seccional: FILETES RES (COSTO ADICIONAL / EXTRA)
- **Filete Arriero**: *Salsa obscura sabrosa con cebolla cambray asada.*
- **Filete al Vino**: *Filete en salsa obscura con un toque robusto de vino tinto.*
- **Filete a la Mostaza Antigua**: *Salsa obscura clásica y un toque de mostaza de grano antigua.*
- **Filete al Brandy**: *Salsa a base de crema fina con un toque aromático de brandy.*
- **Filete a la Pimienta**: *Salsa obscura clásica con un toque fuerte de pimienta negra triturada.*

#### 🔸 Seccional: SALMÓN (COSTO ADICIONAL / EXTRA)
- **Salmón Frutos Rojos**: *Filete de salmón bañado con una salsa dulce de bayas silvestres del bosque.*
- **Salmón al Vino Blanco**: *Salmón al horno en salsa de vino blanco con ajo e hinojo fresco.*
- **Salmón en Salsa Cremosa de Ajo**: *Bañado en salsa cremosa de champiñones fileteados con ajo dorado.*
- **Salmón en Salsa de Naranja**: *Bañado en una salsa cítrica hecha a base de jugo de naranja natural y esencias.*

#### 🔸 Seccional: GUARNICIONES
...
#### 🔸 Seccional: POSTRES
- Tartaleta con frutas de temporada.
- Strudel de manzana con helado de vainilla.
- Panna Cotta italiana con salsa de frutos rojos.
- Cheesecake con geleé de maracuyá.
- Brownie de chocolate fudge caliente servido con helado de vainilla.

---

### 🥗 Menú Buffet Mexicano
* **Descripción**: Servicio tradicional mexicano ideal para tornabodas, celebraciones patrias o eventos rústicos. Incluye tortillas hechas a mano en vivo, salsas tradicionales, ensalada de nopales, arroz y frijoles refritos. Todo servido en Chafing Dishes (baño maría) durante un periodo continuo de 2 horas. El cliente elige 5 guisados del catálogo:
* **Página de Referencia**: [Enlace al sitio](https://primaveraeventsgroup.com/menu-gourmet/menu-primavera-2026/buffet-mexicano/)

#### 🔸 Guisados de POLLO:
- Mole Rojo (receta tradicional)
- Mole Verde campestre
...
- Puntas de Res al Chipotle
- Alambre de Res con queso
- Fajitas de Res
- Picadillo de Res clásico
- Bistec de Res en salsa de chile pasilla

#### 🔸 Guisados de CERDO:
- Costillitas de Cerdo en Adobo
- Costilla de Cerdo en Salsa Verde
- Cochinita Pibil yucateca con cebollitas
- Tinga de Cerdo
- Chicharrón de Cerdo en Salsa Verde/Roja
- Cerdo en Mole Rojo
- Bistec de Cerdo en Salsa de Chile Morita
- Bistec de Cerdo en Salsa de Chile Pasilla

#### 🔸 Guisados de VERDURAS Y MIXTOS:
- Calabacitas a la Mexicana con elote
- Rajas Poblanas con Crema y elote
- Papas con Chorizo doradas
- Nopales con Cecina de Yecapixtla
- Salpicón de Pollo fresco
- Salpicón de Res clásico
- Queso en Chile verde

---

### 🥗 Menú Parrillada de Cortes de Carne en Buffet
* **Descripción**: Servicio de parrillada de cortes selectos cocinados al carbón y puestos en buffet durante un periodo continuo de 2.5 horas. El menú incluye una selección rica de guarniciones, pastas y ensaladas.
* **Página de Referencia**: [Enlace al sitio](https://primaveraeventsgroup.com/menu-gourmet/menu-primavera-2026/buffet-mexicano/buffet-pastas-y-pizzas/parrillada-de-cortes-de-carne-y-guarniciones-en-buffet/)

#### 🔸 PASTAS A ELEGIR:
- Pluma Arrabbiata (pasta corta picante)
- Pasta Alfredo con mantequilla y crema
- Fetuccini Carbonara con tocino crujiente
- Espagueti al Pesto con albahaca
- Espagueti en Salsa de Tres Quesos
...
- Puré rústico de papa con tocino dorado.
- Cebollas cambray asadas al carbón.
- Nopalitos asados fritos.

#### 🔸 CORTES DE CARNE PUESTOS:
- Rib Eye premium.
- Chistora clásica.
- Arrachera marinada súper suave.
- New York fino.
- Chorizo Argentino de autor.

#### 🔸 SUPLEMENTOS Y ADEREZOS:
- Salsa verde de chile serrano.
- Salsa roja de chile morita tatemado.
- Limones frescos.
- Chimichurri argentino preparado en casa.

---

### 🥗 Menú Buffet de Pastas y Pizzas
* **Descripción**: Servicio de buffet con una variedad exquisita de pastas tradicionales y pizzas artesanales horneadas al momento, ideal para eventos dinámicos y graduaciones de corte juvenil.
* **Página de Referencia**: [Enlace al sitio](https://primaveraeventsgroup.com/menu-gourmet/menu-primavera-2026/buffet-mexicano/buffet-pastas-y-pizzas/)

---

### 🥗 Menú de Postres y Repostería Fina
* **Descripción**: Catálogo exclusivo de repostería de autor, diseñado para dar el cierre perfecto al banquete del evento.
* **Página de Referencia**: [Enlace al sitio](https://primaveraeventsgroup.com/nuestros-postres/)
...
## 🏰 Locaciones (Salones, Quintas y Jardines)

### 🏛️ Centro de Convenciones Presidente
* **Ubicación**: Avenida Defensa Nacional #8, Col. Chamilpa, 62210 Cuernavaca, Morelos
* **Capacidad Máxima**: **Desde 100 hasta 500 personas máximo**
...
* **Capacidad Máxima**: **Desde 100 hasta 250 personas en área techada, ampliable en jardines**
* **Estilo Arquitectónico**: Finca campestre íntima y natural de alto confort y descanso.
...
### 🏛️ Finca Las Isabeles
* **Ubicación**: Xochitepec, Morelos
* **Capacidad Máxima**: **Desde 200 hasta 400 invitados**
* **Estilo Arquitectónico**: Finca campestre rústica elegante de gran exclusividad.
...
### 🏛️ Jardín La Flor
* **Ubicación**: Morelos
* **Capacidad Máxima**: **Ideal para eventos de escala media (100 - 300 invitados)**
* **Estilo Arquitectónico**: Jardín clásico cuernavaquense, fresco e íntimo.
...
### 🏛️ Salón Los Potrillos
* **Ubicación**: Morelos
* **Capacidad Máxima**: **Adecuado para eventos de temática ecuestre o rústica (100-400px)**
* **Estilo Arquitectónico**: Hacienda o salón con toque campirano y picadero de caballos.
...
### 🏛️ Jardín Tsu Nuum
* **Ubicación**: Morelos
* **Capacidad Máxima**: **Ideal para eventos al aire libre exclusivos y de autor**
* **Estilo Arquitectónico**: Jardín zen moderno minimalista con paisajismo de diseñador.
...
### 🏛️ Salón Los Caballos
* **Ubicación**: Morelos
* **Capacidad Máxima**: **Diseñado para eventos masivos y corporativos campestres**
* **Estilo Arquitectónico**: Rancho / Hacienda de gran escala con establos elegantes.
...
### 🏛️ Salón Jardín Yolomecatl
* **Ubicación**: Temixco, Morelos
* **Capacidad Máxima**: **Desde 200 hasta 500 invitados**
* **Estilo Arquitectónico**: Complejo de eventos con jardines y salón señorial.
...
### 🏛️ Villa Di Fiori
* **Ubicación**: Xochitepec, Morelos
* **Capacidad Máxima**: **Desde 100 hasta 350 invitados**
* **Estilo Arquitectónico**: Villa toscana campestre elegante con hermosos arcos de cantera.
* **Página de Referencia**: [Enlace al sitio / Repositorio](https://primaveraeventsgroup.com/venues/villa-di-fiori/)

#### 🌳 Características y Facilidades del Recinto:
- Jardines de diseño paisajista europeo con abundante flora exótica.
- Estructuras y portales de cantera tallada ideales para sesiones de fotos premium y ceremonias exclusivas.
- Suite de preparación exclusiva y privada para anfitriones y quinceañeras.
- Gran capacidad logística de montaje de banquetes y estacionamiento cerrado seguro.

---

### 🏛️ Salón & Jardín Solaire
* **Ubicación**: Cuernavaca, Morelos
* **Capacidad Máxima**: **Desde 80 hasta 180 invitados**
* **Estilo Arquitectónico**: Industrial-chic moderno premium con toques de madera sólida y vegetación colgante.
* **Página de Referencia**: [Enlace al sitio / Repositorio](https://primaveraeventsgroup.com/venues/solaire/)

#### 🌳 Características y Facilidades del Recinto:
- Pista Pixel LED 5x5 inteligente pre-instalada de fábrica, ideal para bailes dinámicos.
- Mobiliario de autor rústico elegante incluido en montajes base (sillas Crossback de madera, mesas de madera sólida).
- Cascada o caída de agua monumental iluminada en el jardín de bienvenida.
- Área consagrada para ceremonias religiosas o civiles al aire libre en un ambiente elegante y natural.

---

## 💡 Servicios Corporativos y Especiales

### 🛠️ Servicio de Transportación Ejecutiva y Turística
* **Descripción**: Servicio profesional de transporte ejecutivo y traslado para anfitriones e invitados en el estado de Morelos y CDMX. Flotilla equipada con A/C, choferes profesionales certificados, seguro de viajero completo y atención personalizada.
* **Página de Referencia**: [Enlace al sitio](https://primaveraeventsgroup.com/transportacion/)
...
### 🛠️ Servicio de Montajes Especiales y Alquiler de Mobiliario
* **Descripción**: Catálogo extenso de mobiliario de gala, rústico e industrial para diseño de eventos en Cuernavaca y zonas aledañas. Equipamiento premium y en constante renovación para lograr montajes vanguardistas.
* **Página de Referencia**: [Enlace al sitio](https://primaveraeventsgroup.com/montajes-y-mobiliario/)
...
### 🛠️ Servicio de Staffing y Personal Profesional de Eventos
* **Descripción**: Provisión de personal altamente capacitado, uniformado y con amplia vocación de servicio para la operación de bodas, XV años, graduaciones y eventos corporativos.
* **Página de Referencia**: [Enlace al sitio](https://primaveraeventsgroup.com/staffing/)
...
### 🛠️ Servicios Profesionales de Fotografía y Video Cinematográfico
* **Descripción**: Estudio de producción multimedia propio especializado en inmortalizar los eventos con un enfoque cinematográfico de autor, sensible y moderno.
* **Página de Referencia**: [Enlace al sitio](https://primaveraeventsgroup.com/fotografia-y-video/)
...
### 🛠️ Planeación y Coordinación Integral de Bodas Destino
* **Descripción**: Coordinación completa 'llave en mano' para bodas espectaculares en el estado de Morelos. Nos encargamos de todo el trayecto desde el diseño conceptual hasta el último minuto del evento.
* **Página de Referencia**: [Enlace al sitio](https://primaveraeventsgroup.com/bodas/)
...
### 🛠️ Organización y Diseño de Eventos de Quinceañeras (XV Años)
* **Descripción**: Servicio exclusivo para transformar los XV años en una noche mágica con temáticas juveniles y modernas. Enfoque vibrante en la pista de baile, ambientación LED y espectáculos interactivos.
* **Página de Referencia**: [Enlace al sitio](https://primaveraeventsgroup.com/quinceaneras-primavera/)
...
### 🛠️ Producción y Coordinación de Graduaciones Escolares y Universitarias
* **Descripción**: Producción integral y gala de graduación para colegios y universidades, garantizando orden absoluto, emotividad y una noche de fiesta inolvidable para alumnos y familias.
* **Página de Referencia**: [Enlace al sitio](https://primaveraeventsgroup.com/graduaciones-primavera/)
...
## 📝 Ejemplos de Cotizaciones Reales y de Campo

### 📄 Cotización: Colegio Don Bosco (Graduación y Entrega de Reconocimientos)
* **Recinto / Locación**: Jardín Salón Yolomecatl (Calle Palma 6, Acatlipa, Temixco, Morelos)
* **Costo por Persona**: **$550.00 MXN** (Mínimo requerido: `200 personas`)
...
### 📄 Cotización: Quinceañera Yamilet (XV Años)
* **Recinto / Locación**: Jardín Salón Yolomecatl (Calle Palma 6, Acatlipa, Temixco, Morelos)
* **Costo por Persona**: **$350.00 MXN** (Mínimo requerido: `200 personas`)
* **Coordinadores Responsables**: Gerente Carlos Osorio y Planner Richard Hernández
...
### 📄 Cotización: XV Años Antonio (Propuesta Premium)
* **Recinto / Locación**: Selección a elegir (ccPresidente, Los Potrillos, Los Caballos, La Flor, Yolomecatl)
* **Costo por Persona**: **$950.00 MXN** (Total: **$123,500.00 MXN**) (Mínimo requerido: `130 personas`)

#### 📋 Servicios e Inclusiones de la Cotización:
- Estructura interactiva premium (3 marcas: Banquetes Primavera, ccPresidente, Fotografía, música al entrar `marcasonora.mp3` en bucle, preloader interactivo con video).
...
- DJ profesional con torres robóticas, luces wash, máquina de humo y pista de baile inteligente de 5x5m.
- Coordinador VIP, hostess, staff de meseros capacitados, bartender profesional.
- Cortesías incluidas: Degustación exclusiva para 4 personas, letras gigantes, corazón iluminado, mesas de pastel/regalos, 2 chisperos, alfombra roja, espejo selfie y barra mix con 12 toppings.
...
### 📄 Cotización: Banquete Señor Erasmo (Villa Di Fiori)
* **Recinto / Locación**: Villa Di Fiori (Estilo toscano-elegante, Xochitepec, Morelos)
* **Costo por Persona**: **$850.00 MXN** (Total: **$102,000.00 MXN**) (Mínimo requerido: `120 personas`)

#### 📋 Servicios e Inclusiones de la Cotización:
- Banquete formal de 3 tiempos premium (Entrada, Plato fuerte, Postre).
- Uso de locación Villa Di Fiori con sus icónicos arcos de cantera y hermosos jardines.
...
### 📄 Cotización: Señor Erasmo VIP (Propuesta Extendida)
* **Recinto / Locación**: Villa Di Fiori (Xochitepec, Morelos)
* **Costo por Persona**: **$850.00 MXN** (Mínimo requerido: `120 personas`)
...
- Letras decorativas de marca y ambientación de lujo con iluminación perimetral.

---

### 📄 Cotización: Propuesta Viky (Jardín Solaire)
* **Recinto / Locación**: Salón & Jardín Solaire (Cuernavaca, Morelos)
* **Costo por Persona**: **$1,199.00 MXN** (Mínimo requerido: `100 personas`)

#### 📋 Servicios e Inclusiones de la Cotización:
- Banquete gourmet a 3 tiempos a elegir de nuestra carta exclusiva.
- Descorche libre de 8 horas sin costo de servicio (sin cargo por botella).
...
### 📄 Cotización: Propuesta Viviana (Aniversario Especial)
* **Recinto / Locación**: Servicio a Domicilio / Locación Externa
* **Costo por Persona**: **$690.00 MXN** (Total: **$62,100.00 MXN**) (Mínimo requerido: `90 personas`)

#### 📋 Servicios e Inclusiones de la Cotización:
- Banquete formal a 3 tiempos servido caliente en la locación elegida por el cliente.
...
### 📄 Cotización: Sistema DIF / Lic. Claudia López (Desayuno Tipo Taquiza)
* **Recinto / Locación**: Servicio a Domicilio / Auditorio DIF
* **Costo por Persona**: **$260.00 MXN** (Total: **$32,500.00 MXN**) (Mínimo requerido: `125 personas`)

#### 📋 Servicios e Inclusiones de la Cotización:
- Desayuno tipo taquiza servido caliente en chafing dishes.
- Buffet tradicional (variedad de guisados mexicanos, arroz, frijoles refritos, chicharrón, nopales, tortillas calientes).
...
- Personal de meseros uniformados, stewards de cocina y coordinador general de servicio.

---

### 📄 Cotización: Edimael Becerra (Taquiza Especial)
* **Recinto / Locación**: Servicio a Domicilio / Locación Externa
* **Costo por Persona**: **$125.00 MXN** (Mínimo requerido: `100 personas`)
...
- Vajilla y cubiertos desechables biodegradables, refrescos tradicionales en barra libre.

---

### 📄 Cotización: Paquete Día del Maestro Premium (Propuesta Maestros)
* **Recinto / Locación**: A elegir: Salón Los Caballos o Jardín Los Reyes
* **Costo por Persona**: **$545.00 MXN** (Total: **$43,600.00 MXN**) (Mínimo requerido: `80 personas`)
...
### 📄 Cotización: Sra. Sandra (Taquiza Premium XV Años)
* **Recinto / Locación**: Jardín Solaire (Sábado 20 de Junio)
* **Costo por Persona**: **$590.00 MXN** (Total: **$47,200.00 MXN**) (Mínimo requerido: `80 personas`)
...
## 📢 Políticas Comerciales y Promociones Especiales

### 🌟 Promoción Estrella: Invitación Digital Premium Gratis
* **Valor Comercial Estimado**: `$4,000.00 MXN a $8,000.00 MXN`
* **Condición de Aplicación**: Incluida sin costo adicional al contratar cualquier paquete de banquetes completo en Primavera Events Group.

#### 📋 Características Incluidas en la Invitación Digital:
...
> Estas locaciones ya cuentan con material audiovisual propio para el impulso de campañas publicitarias pagadas y orgánicas:
...
## 📰 Publicaciones del Blog y Entradas de WordPress

### 🏷️ Entrada: Expo Boda y Quince Años - Centro de Convenciones Presidente
* **Página de Referencia**: [Enlace al sitio](https://primaveraeventsgroup.com/expo-boda-y-quince-anos-centro-de-convenciones-presidente/)
* **Fecha de Publicación**: 23 de abril de 2026
* **Autor**: Salomón

#### 📋 Resumen del Contenido:
Gran encuentro de proveedores de eventos en Morelos. Reunió expertos en banquetes, fotografía, decoración, locaciones y más. Se llevó a cabo el 21 de junio en el Centro de Convenciones Presidente de 12:00 PM a 7:00 PM. Presentó la pasarela Haute Runway e incluyó promociones de sorteos exclusivos para asistentes.
...
### 🏷️ Entrada: Expo Boda y 15 Años en Temixco
* **Página de Referencia**: [Enlace al sitio](https://primaveraeventsgroup.com/expo-boda-y-15-anos/)
* **Fecha de Publicación**: 14 de abril de 2026
* **Autor**: Salomón

#### 📋 Resumen del Contenido:
Encuentro de proveedores en Temixco, Morelos. Celebrado en Villa Los Presidentes (Calle Lázaro Cárdenas 17, Temixco) el 19 de abril de 2:00 PM a 8:00 PM. Se sortearon 2 invitaciones digitales premium entre los registrados en vivo.

#### ✨ Elementos Destacados:
- Ubicación excelente.
- Sorteo de invitaciones digitales.
- Asesoría personalizada.

---

### 🏷️ Entrada: Pasarela Primavera Haute Runway
* **Página de Referencia**: [Enlace al sitio](https://primaveraeventsgroup.com/primavera-haute-runway/)
* **Fecha de Publicación**: 10 de mayo de 2026
* **Autor**: Salomón

#### 📋 Resumen del Contenido:
Concepto emocional dentro de la Expo Boda & XV Años celebrado el 21 de junio en el Centro de Convenciones Presidente. Permite a quinceañeras previas vestir nuevamente sus vestidos y modelar en pasarela para inspirar a futuras festejadas con tendencias y estilos reales de forma presencial.

#### ✨ Elementos Destacados:
- Revivir el gran día.
- Modelaje en pasarela real.
- Inspirar a nuevas festejadas.

---

### 🏷️ Entrada: Damas y Caballeros de Honor
* **Página de Referencia**: [Enlace al sitio](https://primaveraeventsgroup.com/wedding-bridesmaids-groomsmen/)
* **Autor**: Salomón

#### 📋 Resumen del Contenido:
Artículo del blog enfocado en los roles y responsabilidades de las damas de honor y caballeros en el cortejo nupcial, ofreciendo consejos de etiqueta y organización para una boda fluida.

---

### 🏷️ Entrada: Locación del Evento
* **Página de Referencia**: [Enlace al sitio](https://primaveraeventsgroup.com/wedding-event-location/)
* **Autor**: Salomón

#### 📋 Resumen del Contenido:
Consejos e ideas clave para elegir la locación ideal en el estado de Morelos, analizando factores clave como clima, espacio cerrado vs abierto, distancias y opciones de alojamiento.

---

### 🏷️ Entrada: Preparativos Finales de Boda
* **Página de Referencia**: [Enlace al sitio](https://primaveraeventsgroup.com/wedding-final-preparation/)
* **Autor**: Salomón

#### 📋 Resumen del Contenido:
Checklist y guías cronológicas detalladas de los preparativos que deben realizarse los últimos 30 días antes del gran día de la boda para evitar imprevistos y asegurar que la logística de proveedores y timings funcione impecable.

---

## 👥 Organigrama y Equipo de Colaboradores Reales

### 👤 Richard Hernández & Jessica Patricia Sandoval (CP)
* **Cargo/Rol**: **Dirección General**
* **Descripción**: Co-propietarios y directores generales de Primavera Events Group, responsables de la planificación ejecutiva, administración general y dirección creativa in-house.

### 👤 Alex Salomón (INIT-IDEA)
* **Cargo/Rol**: **Soporte Digital & Virtual Concierge**
* **Descripción**: Encargado de la infraestructura web interactiva, desarrollo del dashboard de expositores, soporte técnico digital y community management de la marca.

### 👤 Rubí Alvarado
* **Cargo/Rol**: **Enlace en Sede (CC Presidente)**
* **Descripción**: Gerente del Centro de Convenciones Presidente en Córdoba/Cuernavaca, encargada de la coordinación en sede, logística de montaje y enlace directo con clientes. Tel: `+52 271 114 8997`.

---

## 🎨 Manual de Branding e Identidad Visual y Sonora

### 🖌️ Colores Corporativos Oficiales:

| Color | Hexadecimal | RGB | Uso Recomendado |
| --- | --- | --- | --- |
| **Rosa Principal** | `#F65C7A` (o `#f05a7e`) | `rgb(246, 92, 122)` | Color de acento primario, CTAs y elementos interactivos en web. |
| **Rosa Claro** | `#FF8FA3` (o `#f78da7`) | `rgb(255, 143, 163)` | Decoraciones secundarias, degradados de marca. |
| **Oro Noble** | `#C9A96E` | `rgb(201, 169, 110)` | Bordes decorativos de lujo y elementos de gala tradicionales. |
| **Gris Suave** | `#6D6D6D` | `rgb(109, 109, 109)` | Texto de cuerpo, subtítulos y descripciones legibles. |
| **Negro Profundo** | `#1F1F1F` | `rgb(31, 31, 31)` | Títulos principales, fondos de tarjetas y alto contraste. |
...
- **Archivo**: `identidadsonora1.mp3` — *Uso*: Utilizada en `index.html` de la Expo (fase de expectativa al público).
- **Archivo**: `identidadsonora2.mp3` — *Uso*: Utilizada en `plan-marketing.html` (enfoque B2B y aliados comerciales).
- **Archivo**: `identidadsonora3.mp3` — *Uso*: Utilizada en `manual.html` (enfoque emocional y pasarela Haute Runway).
- **Archivo**: `marcasonora.mp3` — *Uso*: Música de precarga y ambientación interactiva para las cotizaciones de clientes (como la propuesta premium de Antonio).

---

## 🚀 Plan Estratégico de Marketing (Campaña Mensual)
* **Eslogan de Campaña**: *«2026 es un año para casarse»*
* **Fecha Oficial del Gran Encuentro (Expo)**: **21 de Junio de 2026**
* **Contraseña Interna de Acceso al Plan**: `PrimaveraVIP`

### 🔗 Enlaces y Utilidades Estratégicas (Google Drive):
- **[Drive de Descargas Oficiales (Media Kit)](https://drive.google.com/drive/folders/168BJ-2D2Ul6qDIBNU9w8oeLHLkVHF5Y5?usp=sharing)**: Carpeta oficial con plantillas, logotipos, folletos y recursos multimedia de la marca.
- **[Drive de Carga de Media Kits por Marca (Aliados)](https://drive.google.com/drive/folders/1WDpTEL5nAeHbUzz63820Z-bZr0GOe3AC?usp=sharing)**: Carpeta destinada a que marcas colaboradoras suban sus logotipos, banners y materiales para la integración del plan promocional.
